...
class ShapeAnalysis:
    ...
    def analysis(self, frame):
        ...
        for cnt in range(len(contours)):
            ...
            cx = 0 if mm['m00'] == 0 else int(mm['m10'] / mm['m00'])
            cy = 0 if mm['m00'] == 0 else int(mm['m01'] / mm['m00'])
...
if __name__ == "__main__":
    cap = cv.VideoCapture('/Users/hujianhang/PycharmProjects/slambook_python/2.mp4')
    while True:
        ret, src = cap.read()
        if ret:
            ld = ShapeAnalysis()
